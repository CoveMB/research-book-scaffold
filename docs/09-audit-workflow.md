...
Store audit notes in `notes/90-audits/audits/`.
...
Each audit includes scope, files checked, checks run, skipped checks, findings,
severity, required fixes, evidence gaps, unresolved risks, decision, and
follow-up.
