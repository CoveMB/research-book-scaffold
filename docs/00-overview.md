...
| ARS Codex | Native academic workflow plugin | After explicit optional installation, provide `academic-research-suite` for paper planning, peer-review style critique, deep research, and pipeline design. |
