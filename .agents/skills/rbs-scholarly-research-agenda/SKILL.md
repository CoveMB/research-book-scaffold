---
name: rbs-scholarly-research-agenda
description: Use when the external Research Book Skills `scholarly-research-agenda` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `scholarly-research-agenda` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/scholarly-research-agenda/SKILL.md
```
