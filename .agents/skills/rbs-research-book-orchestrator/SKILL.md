...
Read `skill-plugins/research-book-skills/skills/research-book-orchestrator/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
