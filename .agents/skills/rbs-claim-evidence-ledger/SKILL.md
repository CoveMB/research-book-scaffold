...
description: Use when the vendored Research Book Skills `claim-evidence-ledger` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `claim-evidence-ledger` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/claim-evidence-ledger/SKILL.md
```
