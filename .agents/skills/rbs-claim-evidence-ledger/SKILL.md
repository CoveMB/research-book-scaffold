---
name: rbs-claim-evidence-ledger
description: Use when the external Research Book Skills `claim-evidence-ledger` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `claim-evidence-ledger` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/claim-evidence-ledger/SKILL.md
```
