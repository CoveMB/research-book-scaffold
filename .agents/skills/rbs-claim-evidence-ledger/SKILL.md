...
Read `skill-plugins/research-book-skills/skills/claim-evidence-ledger/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
