---
name: rbs-manuscript-continuity-editor
description: Use when the external Research Book Skills `manuscript-continuity-editor` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `manuscript-continuity-editor` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/manuscript-continuity-editor/SKILL.md
```
