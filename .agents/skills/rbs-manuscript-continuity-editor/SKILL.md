...
description: Use when the vendored Research Book Skills `manuscript-continuity-editor` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `manuscript-continuity-editor` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/manuscript-continuity-editor/SKILL.md
```
