...
Read `skill-plugins/research-book-skills/skills/manuscript-continuity-editor/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
