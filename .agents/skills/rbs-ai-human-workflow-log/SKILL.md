...
Read `skill-plugins/research-book-skills/skills/ai-human-workflow-log/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
