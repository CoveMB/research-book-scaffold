---
name: rbs-dyslexia-friendly-prose-editor
description: Use when the external Research Book Skills `dyslexia-friendly-prose-editor` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `dyslexia-friendly-prose-editor` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/dyslexia-friendly-prose-editor/SKILL.md
```
