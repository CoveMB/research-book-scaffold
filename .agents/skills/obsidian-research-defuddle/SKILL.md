...
Read `skill-plugins/obsidian-skills/skills/defuddle/SKILL.md` before use. Obey `AGENTS.md`; local citation, evidence, and folder rules override upstream guidance.
