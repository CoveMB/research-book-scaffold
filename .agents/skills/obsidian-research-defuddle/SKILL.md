---
name: obsidian-research-defuddle
description: Use when the external Obsidian Skills `defuddle` guidance is needed for a research vault while preserving local citation, evidence, and folder rules.
---

# obsidian-research-defuddle

## Purpose

Use the external Obsidian Skills `defuddle` workflow as reviewed reference material for this research manuscript repository.
...
```text
skill-plugins/obsidian-skills/skills/defuddle/SKILL.md
```
