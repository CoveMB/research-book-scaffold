---
name: rbs-book-proposal-scholarship
description: Use when the external Research Book Skills `book-proposal-scholarship` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `book-proposal-scholarship` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/book-proposal-scholarship/SKILL.md
```
