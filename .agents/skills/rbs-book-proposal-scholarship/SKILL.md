...
description: Use when the vendored Research Book Skills `book-proposal-scholarship` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `book-proposal-scholarship` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/book-proposal-scholarship/SKILL.md
```
