...
Read `skill-plugins/research-book-skills/skills/book-proposal-scholarship/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
