...
Read `skill-plugins/research-book-skills/skills/systematic-source-discovery/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
