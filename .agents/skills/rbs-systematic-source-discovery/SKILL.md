...
description: Use when the vendored Research Book Skills `systematic-source-discovery` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `systematic-source-discovery` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/systematic-source-discovery/SKILL.md
```
