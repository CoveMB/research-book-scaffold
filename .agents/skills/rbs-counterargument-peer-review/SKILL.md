...
Read `skill-plugins/research-book-skills/skills/counterargument-peer-review/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
