...
description: Use when the vendored Research Book Skills `counterargument-peer-review` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `counterargument-peer-review` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/counterargument-peer-review/SKILL.md
```
