---
name: rbs-counterargument-peer-review
description: Use when the external Research Book Skills `counterargument-peer-review` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `counterargument-peer-review` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/counterargument-peer-review/SKILL.md
```
