...
Read `skill-plugins/research-book-skills/skills/annotation-to-source-note/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
