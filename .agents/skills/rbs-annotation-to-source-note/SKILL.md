---
name: rbs-annotation-to-source-note
description: Use when the external Research Book Skills `annotation-to-source-note` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `annotation-to-source-note` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/annotation-to-source-note/SKILL.md
```
