...
Read `skill-plugins/research-book-skills/skills/research-intent-router/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
