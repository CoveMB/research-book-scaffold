...
description: Use when the vendored Research Book Skills `research-intent-router` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `research-intent-router` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/research-intent-router/SKILL.md
```
