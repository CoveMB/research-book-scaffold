---
name: rbs-research-intent-router
description: Use when the external Research Book Skills `research-intent-router` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `research-intent-router` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/research-intent-router/SKILL.md
```
