...
description: Use when the vendored Research Book Skills `chapter-architecture` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `chapter-architecture` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/chapter-architecture/SKILL.md
```
