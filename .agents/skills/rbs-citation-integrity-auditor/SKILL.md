...
description: Use when the vendored Research Book Skills `citation-integrity-auditor` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `citation-integrity-auditor` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/citation-integrity-auditor/SKILL.md
```
