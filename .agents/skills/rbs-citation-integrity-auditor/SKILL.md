---
name: rbs-citation-integrity-auditor
description: Use when the external Research Book Skills `citation-integrity-auditor` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `citation-integrity-auditor` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/citation-integrity-auditor/SKILL.md
```
