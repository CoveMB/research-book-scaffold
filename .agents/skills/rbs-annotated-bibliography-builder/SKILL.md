...
Read `skill-plugins/research-book-skills/skills/annotated-bibliography-builder/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
