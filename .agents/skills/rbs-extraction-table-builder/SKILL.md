---
name: rbs-extraction-table-builder
description: Use when the external Research Book Skills `extraction-table-builder` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `extraction-table-builder` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/extraction-table-builder/SKILL.md
```
