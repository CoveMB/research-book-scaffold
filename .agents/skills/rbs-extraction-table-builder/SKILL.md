...
Read `skill-plugins/research-book-skills/skills/extraction-table-builder/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
