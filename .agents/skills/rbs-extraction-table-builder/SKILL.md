...
description: Use when the vendored Research Book Skills `extraction-table-builder` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `extraction-table-builder` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/extraction-table-builder/SKILL.md
```
