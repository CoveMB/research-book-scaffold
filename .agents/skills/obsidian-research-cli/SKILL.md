...
Use the external Obsidian Skills `obsidian-cli` workflow as reviewed reference material for this research manuscript repository.
...
```text
skill-plugins/obsidian-skills/skills/obsidian-cli/SKILL.md
```
