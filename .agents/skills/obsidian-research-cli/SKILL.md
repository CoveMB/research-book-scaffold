...
description: Use when the vendored Obsidian Skills `obsidian-cli` guidance is needed for a research vault while preserving local citation, evidence, and folder rules.
---
...
Use the vendored Obsidian Skills `obsidian-cli` workflow as reviewed reference material for this research manuscript repository.
