...
description: Use this wrapper to consult the external Academic Research Skills `academic-paper` workflow after reading and validating the upstream instructions.
---
