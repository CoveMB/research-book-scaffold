---
name: rbs-figure-table-integrity-auditor
description: Use when the external Research Book Skills `figure-table-integrity-auditor` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `figure-table-integrity-auditor` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/figure-table-integrity-auditor/SKILL.md
```
