...
Read `skill-plugins/research-book-skills/skills/figure-table-integrity-auditor/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
