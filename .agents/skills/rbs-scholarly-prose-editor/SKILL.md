...
description: Use when the vendored Research Book Skills `scholarly-prose-editor` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `scholarly-prose-editor` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/scholarly-prose-editor/SKILL.md
```
