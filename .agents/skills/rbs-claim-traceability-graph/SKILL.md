...
Read `skill-plugins/research-book-skills/skills/claim-traceability-graph/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
