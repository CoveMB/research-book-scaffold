---
name: rbs-claim-traceability-graph
description: Use when the external Research Book Skills `claim-traceability-graph` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `claim-traceability-graph` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/claim-traceability-graph/SKILL.md
```
