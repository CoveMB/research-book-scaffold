...
description: Use when the vendored Research Book Skills `claim-traceability-graph` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `claim-traceability-graph` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/claim-traceability-graph/SKILL.md
```
