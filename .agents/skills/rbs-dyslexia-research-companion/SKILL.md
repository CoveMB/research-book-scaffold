---
name: rbs-dyslexia-research-companion
description: Use when the external Research Book Skills `dyslexia-research-companion` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `dyslexia-research-companion` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/dyslexia-research-companion/SKILL.md
```
