...
Read `skill-plugins/research-book-skills/skills/dyslexia-research-companion/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
