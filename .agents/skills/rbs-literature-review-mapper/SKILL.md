...
Read `skill-plugins/research-book-skills/skills/literature-review-mapper/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
