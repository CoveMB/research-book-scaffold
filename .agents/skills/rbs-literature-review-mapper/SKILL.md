---
name: rbs-literature-review-mapper
description: Use when the external Research Book Skills `literature-review-mapper` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `literature-review-mapper` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/literature-review-mapper/SKILL.md
```
