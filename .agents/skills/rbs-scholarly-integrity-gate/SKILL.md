---
name: rbs-scholarly-integrity-gate
description: Use when the external Research Book Skills `scholarly-integrity-gate` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `scholarly-integrity-gate` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/scholarly-integrity-gate/SKILL.md
```
