...
Read `skill-plugins/obsidian-skills/skills/obsidian-markdown/SKILL.md` before use. Obey `AGENTS.md`; local citation, evidence, and folder rules override upstream guidance.
