...
description: Use when the external Obsidian Skills `obsidian-markdown` guidance is needed for a research vault while preserving local citation, evidence, and folder rules.
---
...
Use the external Obsidian Skills `obsidian-markdown` workflow as reviewed reference material for this research manuscript repository.
...
```text
skill-plugins/obsidian-skills/skills/obsidian-markdown/SKILL.md
```
