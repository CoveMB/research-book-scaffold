...
description: Use this wrapper to consult the external Academic Research Skills `academic-pipeline` workflow after reading and validating the upstream instructions.
---
...
Use the external `academic-pipeline` workflow as guidance for academic research discipline.
...
```text
skill-plugins/academic-research-skills/academic-pipeline/SKILL.md
```
