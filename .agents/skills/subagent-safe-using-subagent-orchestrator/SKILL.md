---
name: subagent-safe-using-subagent-orchestrator
...
Use the external Subagent Orchestrator `using-subagent-orchestrator` workflow only as an execution-shape helper for this repository.
...
```text
skill-plugins/subagent-orchestration-plugin/plugin/subagent-orchestrator/skills/using-subagent-orchestrator/SKILL.md
```
