...
Use the vendored Subagent Orchestrator `using-subagent-orchestrator` workflow only as an execution-shape helper for this repository.
...
```text
vendor/subagent-orchestration-plugin/plugin/subagent-orchestrator/skills/using-subagent-orchestrator/SKILL.md
```
