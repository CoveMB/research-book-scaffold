...
Read `skill-plugins/research-book-skills/skills/reading-load-reducer/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
