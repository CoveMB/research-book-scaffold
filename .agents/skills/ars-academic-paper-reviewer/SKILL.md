...
description: Use this wrapper to consult the external Academic Research Skills `academic-paper-reviewer` workflow after reading and validating the upstream instructions.
---
...
Use the external `academic-paper-reviewer` workflow as guidance for academic research discipline.
...
```text
skill-plugins/academic-research-skills/academic-paper-reviewer/SKILL.md
```
