...
description: Use this wrapper to consult the vendored Academic Research Skills `academic-paper-reviewer` workflow after reading and validating the upstream instructions.
---
...
Use the vendored `academic-paper-reviewer` workflow as external guidance for academic research discipline.
