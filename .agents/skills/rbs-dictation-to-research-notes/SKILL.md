...
Read `skill-plugins/research-book-skills/skills/dictation-to-research-notes/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
