---
name: rbs-dictation-to-research-notes
description: Use when the external Research Book Skills `dictation-to-research-notes` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `dictation-to-research-notes` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/dictation-to-research-notes/SKILL.md
```
