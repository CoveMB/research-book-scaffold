...
Read `skill-plugins/obsidian-skills/skills/obsidian-bases/SKILL.md` before use. Obey `AGENTS.md`; local citation, evidence, and folder rules override upstream guidance.
