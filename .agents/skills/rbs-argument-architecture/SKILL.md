...
Read `skill-plugins/research-book-skills/skills/argument-architecture/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
