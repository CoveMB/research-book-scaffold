---
name: rbs-argument-architecture
description: Use when the external Research Book Skills `argument-architecture` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `argument-architecture` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/argument-architecture/SKILL.md
```
