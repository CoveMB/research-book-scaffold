...
description: Use when the vendored Research Book Skills `book-comps-verifier` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `book-comps-verifier` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/book-comps-verifier/SKILL.md
```
