---
name: obsidian-research-canvas
description: Use when the external Obsidian Skills `json-canvas` guidance is needed for a research vault while preserving local citation, evidence, and folder rules.
---

# obsidian-research-canvas

## Purpose

Use the external Obsidian Skills `json-canvas` workflow as reviewed reference material for this research manuscript repository.
...
```text
skill-plugins/obsidian-skills/skills/json-canvas/SKILL.md
```
