---
name: rbs-case-study-integration
description: Use when the external Research Book Skills `case-study-integration` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `case-study-integration` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/case-study-integration/SKILL.md
```
