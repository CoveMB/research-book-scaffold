...
description: Use when the vendored Research Book Skills `case-study-integration` guidance is needed through the local scaffold safety wrapper.
---
...
Use the vendored Research Book Skills `case-study-integration` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
vendor/research-book-skills/skills/case-study-integration/SKILL.md
```
