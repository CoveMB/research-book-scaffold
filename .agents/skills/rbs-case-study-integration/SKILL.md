...
Read `skill-plugins/research-book-skills/skills/case-study-integration/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
