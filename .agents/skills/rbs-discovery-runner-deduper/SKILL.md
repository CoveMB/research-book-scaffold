---
name: rbs-discovery-runner-deduper
description: Use when the external Research Book Skills `discovery-runner-deduper` guidance is needed through the local scaffold safety wrapper.
---
...
Use the external Research Book Skills `discovery-runner-deduper` workflow as reviewed guidance for research book or scholarly nonfiction work in this scaffold.
...
```text
skill-plugins/research-book-skills/skills/discovery-runner-deduper/SKILL.md
```
