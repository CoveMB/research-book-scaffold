...
Read `skill-plugins/research-book-skills/skills/discovery-runner-deduper/SKILL.md` before use. Obey `AGENTS.md`; local scaffold rules override upstream guidance.
