...
- Date of the search.
- Research question or topic being searched.
- Venue searched, such as a database, archive, catalog, search engine, or source bibliography.
- Exact query strings, filters, date ranges, language limits, and other constraints.
- Useful results, rejected results, duplicate sources, and dead ends.
- Follow-up searches, citation chasing tasks, and terms that need testing later.
